...
class TopUpMailNotification extends Notification
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage())
            ->subject('Top Up Berhasil - Terima Kasih Telah Melakukan Transaksi')
            ->greeting('Hai,')
            ->line("Kami ingin menginformasikan bahwa proses top up Anda sebesar Rp {$this->amount} telah berhasil.")
